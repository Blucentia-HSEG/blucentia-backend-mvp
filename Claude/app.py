...
def get_cached_data(endpoint, **kwargs):
    """Cache frequently accessed data"""
    return data_cache.get(f"{endpoint}_{hash(str(kwargs))}")

def set_cached_data(endpoint, data, **kwargs):
    """Set cached data"""
    data_cache[f"{endpoint}_{hash(str(kwargs))}"] = data
